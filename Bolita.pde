class ball {
  ...
  float cx= mouseX;         //coordenadas de la punto del disparador
  float cy= mouseY;         //coordenadas de la punto del disparador
  float vx;                 //Velocidad en x bola
  float vy;                 //Velocidad en y bola
  float corx=(32 * 5 + 1000/2-150)+16;      //coordenadas de salida x
  float cory=(32 * 1 + 700/2-320)-16;       //coordenadas de salidan y
  int numball =5;                           //numero de bolas iniciales
  boolean vida=false;
  float vel=5 ;                             //Velocidad de salida bola       
